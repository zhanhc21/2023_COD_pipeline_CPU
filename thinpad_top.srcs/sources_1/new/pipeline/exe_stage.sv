module EXE_Stage (
    ...
    output reg        exe_branch_mispredict_o  // 1: mispredict
); 
    ...
    always_ff @ (posedge clk_i or posedge rst_i) begin
        if (rst_i) begin
            ...
            exe_branch_mispredict_o <= 1'b0;
        end else begin
            if (stall_i == 1'b0 && 
            (mem_pc_o != exe_pc_i || mem_instr_o != exe_instr_i)) begin
                if (exe_pc_i == 32'h80000070) begin
                    mem_pc_o <= exe_pc_i;
                end
                if (exe_pc_i == 32'h80000058) begin
                    mem_pc_o <= exe_pc_i;
                end
                if (exe_pc_i == 32'h8000002c) begin
                    mem_pc_o <= exe_pc_i;
                end
                mem_pc_o         <= exe_pc_i;
...
//                            if_pc_mux_o <= 1'b0;
                ...
                exe_branch_src_pc_o <= exe_branch_src_pc_o;
                exe_branch_tgt_pc_o <= exe_branch_tgt_pc_o;
                exe_branch_en_o <= exe_branch_en_o;
                exe_branch_mispredict_o <= 1'b0;
            end
        end
    end
